# Generated by Django 4.2.4 on 2024-09-27 15:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category_name",
                    models.CharField(max_length=100, verbose_name="分类名"),
                ),
            ],
            options={
                "verbose_name": "分类管理",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "duration",
                    models.CharField(max_length=50, verbose_name="时长(或集数)"),
                ),
                (
                    "alternate_name",
                ...
                (
                    "image_url",
                    models.CharField(
                        blank=True, max_length=300, verbose_name="图片链接"
                    ),
                ),
                ...
                (
                    "update_info",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="更新信息"
                    ),
                ),
                (
                    "update_progress",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="更新进度"
                    ),
                ),
                (
                    "download_info",
